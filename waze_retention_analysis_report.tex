...
\author{\textbf{Data Science Team}\\
\textit{Advanced Data Analytics Project}}
\date{\today}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{results/correlation_heatmap.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{results/behavioral_analysis.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{results/model_performance_comparison.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{results/feature_importance.png}
